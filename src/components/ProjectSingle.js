...
export default function ProjectSingle() {
  ...
  const { title, sentence, demoLink, githubLink, technologies, features } =
    targetObj;
      ...
      <div className="project-single">
        <div className="project-single__head">
          <div className="contact__heading">
            ...
            <h4 className="grid-points-projects__sentence project-single__head--subheading">
              {sentence}
            </h4>
          </div>
          <ul className="project-single__list">
            <li className="project-single__item">
              <a href={githubLink} target="_blank" rel="noreferrer">
                <ButtonFa classFa={"fab fa-github"} />
              </a>
            </li>
            <li className="project-single__item">
              <a href={demoLink} target="_blank" rel="noreferrer">
                <ButtonFa classFa={"fas fa-link"} />
              </a>
            </li>
          </ul>
        </div>
